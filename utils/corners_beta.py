            ...
            if data:
                ...
                for subtypes in data:  
                    ...
                    if int(subtypes.get('sub_type_id')) == 166:
                            ...
                            if float(over_6_5.get('odd_value')) < float(under_9_5.get('odd_value')):
                                if float(over_6_5.get('odd_value')) < 1.5:
                                    match = {
                                            ...
                                            'prediction': over_6_5.get('odd_key'),
                            ...
                            if float(over_7_5.get('odd_value')) < float(under_9_5.get('odd_value')):
                                if float(over_7_5.get('odd_value')) < 1.5:
                                    match = {
                                            ...
                                            'overall_prob': 0,                            
                                            'sub_type_id': subtypes.get('sub_type_id'),
                                            'prediction': over_7_5.get('odd_key'),
                        ...
                        if over_8_5 and under_10_5:
                            if float(over_8_5.get('odd_value')) < float(under_10_5.get('odd_value')):
                                if float(over_8_5.get('odd_value')) < 1.5:
                                    match = {
                                            ...
                                            'overall_prob': 0,                            
                                            'sub_type_id': subtypes.get('sub_type_id'),
                                            'prediction': over_8_5.get('odd_key'),
